...
public final class ActivityBillingBinding implements ViewBinding {
  ...
  private ActivityBillingBinding(@NonNull LinearLayout rootView, @NonNull RecyclerView rvProducts) {
  ...
  public static ActivityBillingBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityBillingBinding((LinearLayout) rootView, rvProducts);
    }
